...
public class MailListAdapter extends RecyclerView.Adapter<MailListAdapter.ViewHolder> {
    ...
    public MailListAdapter(MailActivityListener listener) {
        this.listener = listener;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_maillist_rv_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (mails != null) {//delete
            ...
            holder.content.setText(Jsoup.parse(current.getContent()).text());
    ...
    public void setMails(List<Mail> mails){
        ...
        if (mails == null || mails.size()==0)  {
            System.out.println("MailListAdapter mails == null");
        } else {
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private ViewHolder(View itemView) {
            super(itemView);
            view = itemView;
            sender = itemView.findViewById(R.id.fragment_maillist_rv_item_sender);
            subject = itemView.findViewById(R.id.fragment_maillist_rv_item_subject);
            content = itemView.findViewById(R.id.fragment_maillist_rv_item_content);
            date = itemView.findViewById(R.id.fragment_maillist_rv_item_date);
        }
